    ...
    return (
      ...
      <View style={{padding:10,margin:10}}>
        {/* {this.state.isLoading ? <ActivityIndicator/> : (
          ...
          <Text style={{fontSize: 30, padding: 60, fontWeight: "bold"}}>Información Recolectada</Text>
          ...
          <View style={{paddingLeft: 10,}}>
            ...
            <View > 
              <Text style={{marginBottom: -20, marginTop: -20, fontSize: 16, fontWeight: "bold"}}>Nombre(s)</Text>
              <MyTextInput
                value={names3rd}
              />
            </View>
