...
export default class App extends Component<Props> {
  ...
  state = {
    ...
    processImage = async(captureImage)  => {      
        var uriBase = "https://myocrapi.cognitiveservices.azure.com/" + "vision/v3.0/ocr";  //endpoint
        // Request parameters.
        var params = {
            "language": "es",
          ...
          let data = {
           ...
           return fetch(uriBase + "?" + params, {
              ...
              headers: { 
                'content-type': 'application/json', 
               "Ocp-Apim-Subscription-Key": "f7c49f2788cc468f8371a3e6cdd03ca0" //subscription key
              },
              method: 'POST',
            }).then(async r => {
